...
def setup_bug_bounty_mcp_server(api_client: BugBountyAPIClient) -> FastMCP:
    ...
    def nuclei_scan(
        ...
        """
        Execute Nuclei vulnerability scanner with enhanced logging and
    ...
    def dirsearch_scan(
        ...
        """
        Execute Dirsearch for advanced directory and file discovery with
        enhanced logging.
        """
        data = {
            "url": url,
    ...
    def paramspider_mining(
        ...
        """
        Execute ParamSpider for parameter mining from web archives with
        enhanced logging.
        """
        data = {
            "domain": domain,
    ...
    def bugbounty_vulnerability_hunting(
        ...
        """
        Create vulnerability hunting workflow prioritized by impact and bounty
        potential.
        """
        data = {
            "domain": domain,
